...
//   FILE : src/admin/clean_expired_validation_code
//   CLASS :                         *
...
console.log(`******STARTED PROCESSING CLEAN EXPIRED VALIDATION CODE ${current_formatted_date} ******`);
...
yp.call("yp_delete_expired_validation_code", []);
yp.dispose();
console.log("******COPLETED PROCESSING CLEAN EXPIRED VALIDATION CODE******\n\n\n");